...
> **首次安装提示：** 当前发布包尚未使用 Apple Developer ID 或 Windows 商业代码签名证书。首次安装时，macOS 可能提示“无法验证开发者”，Windows SmartScreen 可能提示“Windows 已保护你的电脑”。应用内更新包已有独立安全签名，但彻底消除系统首次安装警告仍需要相应平台的商业证书。
...
- 进度条小人默认关闭，可在“更多小组件设置”中开启内置绿色奔跑小人，或上传 GIF、APNG、WebP、PNG、JPEG 自定义动态图标。图标会跟随当天工时进度移动；进入加班后，内置小人会随红色加班进度切换颜色。
...
欢迎大家提出希望这个 App 新增的功能、使用体验建议和问题反馈。可以直接在 [GitHub Issues](https://github.com/Swiaple/workday-widget/issues) 中创建话题；如果你也是开发者，也欢迎提交 Pull Request。提出建议时，最好附上使用场景、期望效果、系统版本以及必要的截图，方便更快理解和实现。
